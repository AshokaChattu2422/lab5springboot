...
public class AccountDaoImpl implements AccountDao {
	...
	/*  {
		  accouts.put(1, new Account(++counter,"Ashoka","Ap","900040468",5000.00,AccountType.SAVING));
	     accouts.put(2, new Account(++counter,"Chattu","Ap","900245677",6000.00,AccountType.SAVING));
